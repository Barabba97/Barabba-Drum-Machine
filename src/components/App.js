...
export default class App extends Component {
  ...
  componentDidUpdate() {
    if (this.handleVolumeTimeout) {
      clearTimeout(this.handleVolumeTimeout);
      this.handleVolumeTimeout = null;
    }
    else {
      this.handleVolumeTimeout = setTimeout(() => {
        this.displayVolumeValue.current.style.setProperty('opacity', 0);
      }, 1000);
    }
  }
      ...
      <div className="drum" id="drum-machine">
        ...
        <div className="drum-control">
          <div className="drum-control-volumn">
            <i className="fa fa-volume-down" ref={this.iconVolume}></i>
            <span> Volume</span>
        ...
        <div className="drum-footer">
          Made by <a href="https://github.com/Barabba97" target="_blank" rel="noreferrer">Barabba</a>
        </div>
      </div>
    );
  }
